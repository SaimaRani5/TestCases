...
public class CreatePackage {
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("/html/body/form/section/div/div/div[2]/div[2]/div[2]/div/div[2]/div/div/h3/a"))
                .click();
        ...
        try {
            ...
            System.out.println("Package created successfully : Passed");
        } catch (Exception e) {
            System.out.println("Package not created successfully : Failed");
        } finally {
            driver.quit();
        }
    }
